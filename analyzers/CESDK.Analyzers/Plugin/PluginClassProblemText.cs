...
///     <see cref="PluginShape" /> predicate (from <c>CESDK.SourceGenerators.Shared</c>) only
...
internal static class PluginClassProblemText
{
    ...
    public static string Describe(PluginShapeIssues problem)
    {
        return problem switch
        {
            ...
            PluginShapeIssues.NotDerivedFromPluginBase => "must derive from 'CESDK.Hosting.Plugin.CheatEnginePlugin'",
            PluginShapeIssues.Inaccessible =>
