...
/// </summary>
/// <param name="pluginAttribute">The resolved <c>CESDK.Annotations.Plugin.CheatEnginePluginAttribute</c>.</param>
...
/// </param>
/// <remarks>
///     Does not carry <c>CESDK.Hosting.Plugin.CheatEnginePlugin</c>: the shared shape predicate
///     (<c>CESDK.SourceGenerators.Shared.Shapes.PluginShape</c>) recognises the base class structurally (name
...
///     registers anything at all for a compilation that does not reference CESDK.
/// </remarks>
