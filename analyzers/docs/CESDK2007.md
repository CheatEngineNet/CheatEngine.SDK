...
Lua bindings add members that are part of their ABI: registration methods, thunks, cached globals, and the borrowed
handle/marshaller members of a `[LuaClass]`. A source member with the same identity makes generated code fail to
compile.
