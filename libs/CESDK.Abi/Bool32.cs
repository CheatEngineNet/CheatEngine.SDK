...
///         <c>CESDK.Abi.Tests</c> on x64 (a function returning a raw <see cref="int" /> is called through a signature
///         returning <see cref="Bool32" />, and the other way round). C# <see cref="bool" /> never appears in a layout or
///         in an unmanaged signature of this assembly: with runtime marshalling disabled it would be a 1-byte,
