...
/// <remarks>
///     <para>
///         <b>The rule this assembly follows.</b> Every public API in <c>CESDK.Engine</c> takes and returns zero-based
///         indices, whatever the Lua side counts from: an index into a Cheat Engine object is passed through unchanged, an
