...
namespace CESDK.Hosting.Context;
...
public sealed unsafe class PluginContext
{
    ...
    ///     code via <c>CheatEnginePlugin.Context</c> — CESDK.Hosting's public surface speaks spans, structs and handles,
    ///     never raw pointers. This is <c>CESDK.Hosting</c>'s own wiring detail for attaching
