...
namespace CESDK.Hosting.Diagnostics;
...
/// </summary>
/// <remarks>
///     Format: <c>[CESDK.Hosting] Error: message</c>, followed by the exception's text on the next lines when there is
///     one. Thread-safe (the OS call is), never throws, allocates the formatted string per entry (error paths only).
/// </remarks>
