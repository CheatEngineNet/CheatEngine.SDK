...
public static unsafe partial class LuaApi
{
    ...
    internal partial struct Table
    {
        ...
        private void LoadDebug(ref ExportResolver exports)
        {
            ...
            lua_getupvalue = (delegate* unmanaged[Cdecl]<lua_State*, int, int, byte*>)exports.Resolve("lua_getupvalue");
            lua_setupvalue = (delegate* unmanaged[Cdecl]<lua_State*, int, int, byte*>)exports.Resolve("lua_setupvalue");
