...
global using unsafe lua_CFunction = delegate* unmanaged[Cdecl]<CESDK.Lua.Interop.Types.lua_State*, int>;
global using unsafe lua_Hook =
    delegate* unmanaged[Cdecl]<CESDK.Lua.Interop.Types.lua_State*, CESDK.Lua.Interop.Types.lua_Debug*, void>;
global using unsafe lua_KFunction = delegate* unmanaged[Cdecl]<CESDK.Lua.Interop.Types.lua_State*, int, nint, int>;
global using unsafe lua_Reader = delegate* unmanaged[Cdecl]<CESDK.Lua.Interop.Types.lua_State*, void*, nuint*, byte*>;
global using unsafe lua_Writer =
    delegate* unmanaged[Cdecl]<CESDK.Lua.Interop.Types.lua_State*, void*, nuint, void*, int>;
