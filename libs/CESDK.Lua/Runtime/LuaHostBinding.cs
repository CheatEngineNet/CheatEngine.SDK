...
///     and the identity of the host's main thread. Built by <c>CESDK.Hosting</c> from Cheat Engine's exported function
///     table when the plugin is enabled, or by a test from <c>[UnmanagedCallersOnly]</c> doubles.
/// </summary>
/// <remarks>
///     <para>
...
///         takes the function pointers exactly as <c>CESDK.Abi.Managed.ManagedExportedFunctions</c> declares them
///         (<c>delegate* unmanaged[Stdcall]&lt;void*&gt;</c> and <c>&lt;void*, void*, void&gt;</c>: the ABI layer cannot
///         name
