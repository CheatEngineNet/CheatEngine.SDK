...
public readonly unsafe partial struct LuaState : IEquatable<LuaState>
{
    ...
    /// </param>
    /// <remarks>
    ///     Constructing a view is a pure value operation; it is the members that need <c>CESDK.Lua.Interop.Api.LuaApi</c> to
    ///     be bound.
    /// </remarks>
    ...
    /// <summary>Gets the address of the native state, for code that talks to <c>CESDK.Lua.Interop</c> directly.</summary>
