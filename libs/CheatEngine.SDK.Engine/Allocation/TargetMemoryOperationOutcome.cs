...
///     .
///     It is <see cref="Lua.Calls.LuaStatus.Ok" /> for every other kind. An absent allocation or rejected deallocation is
///     an
...
public readonly record struct TargetMemoryOperationOutcome
{
	...
	public TargetMemoryOperationOutcomeKind Kind
	{
		get;
	}
