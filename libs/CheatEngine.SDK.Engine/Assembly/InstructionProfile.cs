...
public readonly record struct InstructionProfile
{
    ...
    public CheatEngineArchitecture Architecture { get; }

    /// <summary>Gets the observed target pointer and instruction-address width.</summary>
    public PointerSize AddressWidth { get; }

    /// <summary>Gets the conventional x86 instruction profile.</summary>
    public static InstructionProfile X86 { get; } = new(CheatEngineArchitecture.X86, PointerSize.Bit32);

    /// <summary>Gets the conventional x64 instruction profile.</summary>
    public static InstructionProfile X64 { get; } = new(CheatEngineArchitecture.X64, PointerSize.Bit64);

    /// <summary>Gets the conventional 32-bit ARM instruction profile.</summary>
    public static InstructionProfile Arm32 { get; } = new(CheatEngineArchitecture.Arm32, PointerSize.Bit32);

    /// <summary>Gets the conventional 64-bit ARM instruction profile.</summary>
    public static InstructionProfile Arm64 { get; } = new(CheatEngineArchitecture.Arm64, PointerSize.Bit64);
    ...
    {
        if (!IsValid) return InstructionOperationStatus.InvalidProfile;
