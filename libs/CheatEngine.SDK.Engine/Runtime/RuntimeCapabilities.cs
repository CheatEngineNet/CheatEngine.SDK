...
public sealed class RuntimeCapabilities : IEquatable<RuntimeCapabilities>
{
	...
	public static RuntimeCapabilities Empty
	{
		get;
	} = new(Array.Empty<RuntimeCapabilityAvailability>());
	...
	{
		return TryGet(capability, out RuntimeCapabilityAvailability availability)
			? availability.State
