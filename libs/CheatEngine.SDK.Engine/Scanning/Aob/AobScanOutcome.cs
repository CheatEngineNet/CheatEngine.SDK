...
/// <summary>
///     A compact, allocation-free outcome for
///     <see cref="AobScanner.TryScanOutcome(string, out Objects.Owned{Objects.StringList}?)" />.
/// </summary>
/// <remarks>
...
public readonly struct AobScanOutcome : IEquatable<AobScanOutcome>
{
	...
	public AobScanOutcomeKind Kind
	{
		get;
	}

	/// <summary>
	///     Gets the protected Lua status for a Lua failure; otherwise
	///     <see cref="CheatEngine.SDK.Lua.Calls.LuaStatus.Ok" />.
	/// </summary>
	...
	/// <summary>
	///     Gets whether <see cref="ResultCount" /> was read from a valid host StringList and satisfies its outcome
	///     invariant.
	/// </summary>
