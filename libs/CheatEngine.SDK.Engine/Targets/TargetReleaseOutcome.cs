...
public readonly record struct TargetReleaseOutcome
{
	...
	/// </summary>
	public EngineFailureKind? FailureKind
	{
		get;
	}
	...
	public bool RequiresManualRecovery =>
		Status is not TargetReleaseStatus.Unspecified and not TargetReleaseStatus.Released;
