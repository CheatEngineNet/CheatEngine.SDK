...
public readonly record struct TargetSelectionObservation
{
    ...
    public bool IsQualified => Status == TargetSelectionObservationStatus.CurrentTargetQualified && Incarnation.HasValue;
