...
public static unsafe partial class LuaApi
{
	...
	internal partial struct Table
	{
		...
		private void LoadGet(ref ExportResolver exports)
		{
			...
			lua_rawgeti =
				(delegate* unmanaged[Cdecl]<lua_State*, int, lua_Integer, int>) exports.Resolve("lua_rawgeti");
			...
			lua_newuserdata =
				(delegate* unmanaged[Cdecl]<lua_State*, size_t, void*>) exports.Resolve("lua_newuserdata");
