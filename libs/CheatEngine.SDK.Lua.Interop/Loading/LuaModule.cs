...
namespace CheatEngine.SDK.Lua.Interop.Loading;
...
///     is absent is decided by the caller (<c>CheatEngine.SDK.Hosting</c> in production).
/// </summary>
/// <remarks>
///     <para>
...
public static unsafe partial class LuaModule
{
	...
	public static bool TryGetLoaded(string moduleName, out nint moduleHandle)
	{
		...
		{
			if (GetModuleHandleExW(0, name, &handle) == 0)
			{
				return false;
			}
		}
