...
public readonly record struct LuaRegistrationReleaseOutcome
{
    ...
    public LuaRegistrationReleaseKind Kind { get; }

    /// <summary>Gets the number of globals this lease removed because no prior value existed.</summary>
    public int RemovedCount { get; }

    /// <summary>Gets the number of prior values this lease restored under <see cref="LuaRegistrationCollisionPolicy.ReplaceExisting" />.</summary>
