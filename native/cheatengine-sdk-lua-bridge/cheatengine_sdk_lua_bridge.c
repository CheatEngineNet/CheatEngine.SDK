...
enum
{
    CHEATENGINE_SDK_LUA_BRIDGE_LEGACY_ABI_VERSION = 1, CHEATENGINE_SDK_LUA_BRIDGE_ABI_MAJOR = 1,
    CHEATENGINE_SDK_LUA_BRIDGE_ABI_MINOR = 1
};
...
_Static_assert(offsetof(cheatengine_sdk_lua_exports, gettop) == 0 * sizeof(void*),
               "lua_gettop has an unexpected export-table offset.");
_Static_assert(offsetof(cheatengine_sdk_lua_exports, settop) == 1 * sizeof(void*),
               "lua_settop has an unexpected export-table offset.");
_Static_assert(offsetof(cheatengine_sdk_lua_exports, checkstack) == 2 * sizeof(void*),
               "lua_checkstack has an unexpected export-table offset.");
_Static_assert(offsetof(cheatengine_sdk_lua_exports, rotate) == 3 * sizeof(void*),
               "lua_rotate has an unexpected export-table offset.");
_Static_assert(offsetof(cheatengine_sdk_lua_exports, pushlstring) == 4 * sizeof(void*),
               "lua_pushlstring has an unexpected export-table offset.");
_Static_assert(offsetof(cheatengine_sdk_lua_exports, pushinteger) == 5 * sizeof(void*),
               "lua_pushinteger has an unexpected export-table offset.");
_Static_assert(offsetof(cheatengine_sdk_lua_exports, createtable) == 6 * sizeof(void*),
               "lua_createtable has an unexpected export-table offset.");
_Static_assert(offsetof(cheatengine_sdk_lua_exports, newuserdata) == 7 * sizeof(void*),
               "lua_newuserdata has an unexpected export-table offset.");
_Static_assert(offsetof(cheatengine_sdk_lua_exports, pushcclosure) == 8 * sizeof(void*),
               "lua_pushcclosure has an unexpected export-table offset.");
_Static_assert(offsetof(cheatengine_sdk_lua_exports, pushlightuserdata) == 9 * sizeof(void*),
               "lua_pushlightuserdata has an unexpected export-table offset.");
_Static_assert(offsetof(cheatengine_sdk_lua_exports, rawset) == 10 * sizeof(void*),
               "lua_rawset has an unexpected export-table offset.");
_Static_assert(offsetof(cheatengine_sdk_lua_exports, rawseti) == 11 * sizeof(void*),
               "lua_rawseti has an unexpected export-table offset.");
_Static_assert(offsetof(cheatengine_sdk_lua_exports, rawsetp) == 12 * sizeof(void*),
               "lua_rawsetp has an unexpected export-table offset.");
_Static_assert(offsetof(cheatengine_sdk_lua_exports, rawgetp) == 13 * sizeof(void*),
               "lua_rawgetp has an unexpected export-table offset.");
_Static_assert(offsetof(cheatengine_sdk_lua_exports, rawgeti) == 14 * sizeof(void*),
               "lua_rawgeti has an unexpected export-table offset.");
_Static_assert(offsetof(cheatengine_sdk_lua_exports, type) == 15 * sizeof(void*),
               "lua_type has an unexpected export-table offset.");
_Static_assert(offsetof(cheatengine_sdk_lua_exports, pcallk) == 16 * sizeof(void*),
               "lua_pcallk has an unexpected export-table offset.");
_Static_assert(offsetof(cheatengine_sdk_lua_exports, error) == 17 * sizeof(void*),
               "lua_error has an unexpected export-table offset.");
_Static_assert(offsetof(cheatengine_sdk_lua_exports, l_ref) == 18 * sizeof(void*),
               "luaL_ref has an unexpected export-table offset.");
_Static_assert(offsetof(cheatengine_sdk_lua_exports, l_unref) == 19 * sizeof(void*),
               "luaL_unref has an unexpected export-table offset.");
...
_Static_assert(offsetof(cheatengine_sdk_lua_bridge_contract, contract_size) == 4,
               "The bridge contract size offset changed.");
_Static_assert(offsetof(cheatengine_sdk_lua_bridge_contract, supported_operations) == 8,
               "The bridge contract operation bitmap offset changed.");
_Static_assert(offsetof(cheatengine_sdk_lua_bridge_contract, export_table_size) == 16,
               "The bridge contract table-size offset changed.");
_Static_assert(offsetof(cheatengine_sdk_lua_bridge_contract, abi_major) == 20,
               "The bridge contract major-version offset changed.");
_Static_assert(offsetof(cheatengine_sdk_lua_bridge_contract, abi_minor) == 22,
               "The bridge contract minor-version offset changed.");
_Static_assert(offsetof(cheatengine_sdk_lua_bridge_contract, pointer_size) == 24,
               "The bridge contract pointer-size offset changed.");
_Static_assert(offsetof(cheatengine_sdk_lua_bridge_contract, lua_integer_size) == 25,
               "The bridge contract lua_Integer-size offset changed.");
_Static_assert(offsetof(cheatengine_sdk_lua_bridge_contract, size_t_size) == 26,
               "The bridge contract size_t-size offset changed.");
_Static_assert(offsetof(cheatengine_sdk_lua_bridge_contract, reserved) == 27,
               "The bridge contract reserved offset changed.");
_Static_assert(offsetof(cheatengine_sdk_lua_bridge_contract, reserved_padding) == 28,
               "The bridge contract padding offset changed.");
...
CHEATENGINE_SDK_EXPORT const char cheatengine_sdk_lua_bridge_source_fingerprint[] =
    ...
    case OP_REF:
        {
            ...
            if (a->type(L, -1) != LUA_TTABLE)
            {
                a->settop(L, -2);
                a->createtable(L, 0, 0);
                a->pushlightuserdata(L, (void*)c->data);
                a->rotate(L, -2, 1);
                a->rawset(L, LUA_REGISTRYINDEX);
                a->rawgetp(L, LUA_REGISTRYINDEX, c->data);
            }
...
CHEATENGINE_SDK_EXPORT int CHEATENGINE_SDK_CALL cheatengine_sdk_lua_protected(
    lua_State* L, const cheatengine_sdk_lua_exports* api, int op, int input_count, const void* data, size_t size,
