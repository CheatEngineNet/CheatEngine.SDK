...
namespace CESDK.SourceGenerators.EngineApi.Emit;
...
/// </summary>
/// <remarks>
///     Unlike <c>CESDK.SourceGenerators.LuaBindings</c>'s <c>Emit/LuaGlobalFileEmitter.cs</c>, this emitter writes
...
internal static class EngineApiFileEmitter
{
    ...
    // nuint. CESDK.Lua's pointer-typed marshallers are not reused for it on the public surface. Every entry that
    ...
    private const string EngineAddressTypeName = "global::CESDK.Engine.Values.Address";
    ...
    // conversion, exact and allocation-free because CESDK.Engine.Values.Address and nuint carry the same 64-bit pattern
    ...
    // Address-kind argument is typed CESDK.Engine.Values.Address instead of nuint (results are never Address here,
