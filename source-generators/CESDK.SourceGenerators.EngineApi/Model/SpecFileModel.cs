...
/// <summary>
///     The unit of output for one <c>*.cesdk-api.txt</c> spec file: the type it declares, the distinct globals it binds
...
///     same way <c>CESDK.SourceGenerators.LuaBindings</c> resolves its per-type hint names.
/// </param>
...
{
    /// <summary>Suffix of the hint name: <c>memory-scalars.cesdk-api.txt.EngineApi.g.cs</c>.</summary>
