...
///     spec-file kind is only ever "add a case here", never a change to <c>CESDK.SourceGenerators.Shared.LuaEmit</c>: the
///     vocabulary is fixed
///     by the marshallers <c>CESDK.Lua</c> ships, and this table merely names it for hand-curated text.
/// </remarks>
