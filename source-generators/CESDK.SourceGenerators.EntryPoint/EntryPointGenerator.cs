using CESDK.SourceGenerators.EntryPoint.Emit;
using CESDK.SourceGenerators.EntryPoint.Model;
using CESDK.SourceGenerators.EntryPoint.Parsing;
using CESDK.SourceGenerators.Shared;
using Microsoft.CodeAnalysis;
using Microsoft.CodeAnalysis.CSharp.Syntax;

namespace CESDK.SourceGenerators.EntryPoint;
...
/// <remarks>
///     <para>
///         Output is produced only when generation is switched on (MSBuild property <c>CesdkGenerateEntryPoint</c>,
///         default
///         <c>true</c>) and exactly one valid plugin class exists. In every other case the generator emits nothing and
///         reports nothing: the diagnostics (CESDK0001 and CESDK0002) belong to <c>CESDK.Analyzers</c>.
///     </para>
///     <para>
...
{
    /// <summary>Metadata name of the marker attribute (declared by <c>CESDK.Annotations</c>).</summary>
