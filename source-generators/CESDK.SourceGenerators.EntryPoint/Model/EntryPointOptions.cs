...
namespace CESDK.SourceGenerators.EntryPoint.Model;

/// <summary>The MSBuild switches the generator honours, reduced to values.</summary>
/// <param name="GenerateEntryPoint">
///     <c>CesdkGenerateEntryPoint</c>: <see langword="false" /> switches the generator off (for a plugin author who writes
...
internal readonly record struct EntryPointOptions(bool GenerateEntryPoint)
{
    ...
    public const string GenerateEntryPointKey = BuildProperty.KeyPrefix + "CesdkGenerateEntryPoint";
