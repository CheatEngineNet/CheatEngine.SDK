using CESDK.SourceGenerators.LuaBindings.Emit;
using CESDK.SourceGenerators.LuaBindings.Model;
using CESDK.SourceGenerators.LuaBindings.Parsing;
using CESDK.SourceGenerators.Shared;
using Microsoft.CodeAnalysis;
using Microsoft.CodeAnalysis.CSharp.Syntax;

namespace CESDK.SourceGenerators.LuaBindings;
...
///         and no diagnostic: the CESDK2xxx rules of <c>CESDK.Analyzers</c>, which link the same shape-validation source,
...
{
    /// <summary>Metadata name of the function-export attribute (declared by <c>CESDK.Annotations</c>).</summary>
    internal const string LuaFunctionAttributeMetadataName = AnnotationsMetadataNames.LuaFunctionAttribute;

    /// <summary>Metadata name of the global-binding attribute (declared by <c>CESDK.Annotations</c>).</summary>
