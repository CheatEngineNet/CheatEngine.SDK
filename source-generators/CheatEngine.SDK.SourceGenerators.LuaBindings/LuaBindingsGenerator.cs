...
public sealed class LuaBindingsGenerator : IIncrementalGenerator
{
	...
	private static void ConfigureFunctions(IncrementalGeneratorInitializationContext context)
	{
		...
		IncrementalValueProvider<CompilationFacts> facts = context.CompilationProvider
		...
		IncrementalValuesProvider<LuaFunctionTableModel> functionTables = context.SyntaxProvider
		...
		IncrementalValuesProvider<LuaFunctionTableModel> functionOutputs = functionTables
			.Combine(facts)
	...
	{
		IncrementalValuesProvider<LuaGlobalTableModel> globalTables = context.SyntaxProvider
			.ForAttributeWithMetadataName(
		...
		IncrementalValuesProvider<LuaGlobalTableModel> globalOutputs =
			globalTables.WithTrackingName(LuaBindingsTrackingNames.LuaGlobalOutput);
	...
	{
		IncrementalValuesProvider<LuaClassModel> luaClasses = context.SyntaxProvider
			.ForAttributeWithMetadataName(
	...
	{
		IncrementalValueProvider<ImmutableArray<LuaObjectMethodModel>> objectMethods = context.SyntaxProvider
			.ForAttributeWithMetadataName(
		...
		IncrementalValueProvider<ImmutableArray<LuaObjectPropertyModel>> objectProperties = context.SyntaxProvider
			.ForAttributeWithMetadataName(
		...
		IncrementalValuesProvider<LuaObjectMembersTableModel> objectMemberTables = objectMethods
