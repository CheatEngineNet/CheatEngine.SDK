...
internal static class LuaObjectMembersTables
{
    ...
    {
        if (groups.TryGetValue(type.FullyQualifiedName, out var members)) return members;
    ...
    {
        public ContainingTypeModel ContainingType { get; } = containingType;

        public List<LuaObjectMethodModel> Methods { get; } = [];

        public List<LuaObjectPropertyModel> Properties { get; } = [];
    }
}
