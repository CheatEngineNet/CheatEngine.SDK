...
internal static class LuaBridgeContractDiagnostics
{
    ...
    {
        var descriptor = diagnostic.IsConflict ? ConflictingCatalog : InvalidCatalog;
        var location = Location.Create(diagnostic.Path, diagnostic.Span, diagnostic.LineSpan);
