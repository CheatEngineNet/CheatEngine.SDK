...
/// <summary>
///     Fully-qualified metadata names of the generator-facing <c>CheatEngine.SDK.Annotations</c> marker attributes, and of the
...
/// </summary>
/// <remarks>
///     The single source of truth for these strings. No Roslyn component here can reference <c>CheatEngine.SDK.Annotations</c> or
///     <c>CheatEngine.SDK.Hosting</c> (they are <c>netstandard2.0</c> Roslyn components; those assemblies target <c>net10.0</c>),
...
{
    /// <summary>
    ///     Metadata name of <c>CheatEngine.SDK.Annotations.Plugin.CheatEnginePluginAttribute</c>, the marker attribute of a plugin
    ///     class.
    /// </summary>
    public const string CheatEnginePluginAttribute = "CheatEngine.SDK.Annotations.Plugin.CheatEnginePluginAttribute";

    /// <summary>
    ///     Metadata name of <c>CheatEngine.SDK.Annotations.Lua.LuaFunctionAttribute</c>, which exports a static method to Lua as
    ///     a global C function.
    /// </summary>
