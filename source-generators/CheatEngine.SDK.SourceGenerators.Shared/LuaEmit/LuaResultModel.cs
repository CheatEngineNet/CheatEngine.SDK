...
/// </param>
/// <param name="Name">The name of the <c>out</c> parameter (the value, or the <c>written</c> count), keyword-escaped.</param>
...
///     parameter of any type accepts <c>scoped</c> without it changing whether the two declarations match), so
    ...
    bool DestinationIsScoped = false)
{
    ...
    {
        return new LuaResultModel(LuaResultShape.CopyOut, LuaValueKind.Int32, writtenName, false, destinationName,
            destinationIsScoped);
    }
}
