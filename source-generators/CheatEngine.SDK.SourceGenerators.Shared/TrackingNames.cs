...
/// <summary>
///     Naming convention for incremental-pipeline steps (<c>WithTrackingName</c>) shared by every CheatEngine.SDK generator.
/// </summary>
/// <remarks>
///     <para>
///         Every step of every pipeline is named, with a constant of the form
///         <c>CheatEngine.SDK.&lt;Generator&gt;.&lt;Step&gt;</c>. Each generator declares its own constants class on top of
...
///         <c>GeneratorRunResult.TrackedSteps</c>, keeps the names for which <see cref="IsCheatEngineSdkStep" /> is true, and
///         asserts
