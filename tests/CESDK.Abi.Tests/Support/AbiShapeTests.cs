...
namespace CESDK.Abi.Tests.Support;

/// <summary>
///     Tests of the gate itself. <see cref="AbiShape" /> decides whether a structure added to <c>CESDK.Abi</c> later is
///     acceptable, so each rule it claims to enforce is proven here against a deliberately wrong fixture: a gate that
///     accepts everything would otherwise look exactly like a gate that works.
/// </summary>
