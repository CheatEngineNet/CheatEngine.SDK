...
using CESDK.Analyzers.CodeFixes.Plugin;
using CESDK.Analyzers.CodeFixes.Usage;
...
namespace CESDK.Analyzers.Tests.Diagnostics;
...
public sealed class DiagnosticCatalogTests
{
    ...
    public void Descriptor_has_a_documentation_page_and_a_release_tracking_row(string id)
    {
        ...
        var unshipped =
            File.ReadAllText(RepositoryLayout.PathOf("analyzers/CESDK.Analyzers/AnalyzerReleases.Unshipped.md"));
        var shipped =
            File.ReadAllText(RepositoryLayout.PathOf("analyzers/CESDK.Analyzers/AnalyzerReleases.Shipped.md"));
        Assert.True(
    ...
    // 'CESDK0xxx' -> CESDK.Plugin, 'CESDK1xxx' -> CESDK.Usage, 'CESDK2xxx' -> CESDK.Generation.
