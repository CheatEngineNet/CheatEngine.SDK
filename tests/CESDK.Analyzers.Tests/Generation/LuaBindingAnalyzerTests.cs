...
using CESDK.Analyzers.Generation;
using CESDK.Analyzers.Tests.Infrastructure;
using CESDK.Annotations.Lua;
using CESDK.Lua.Interop.Api;
using CESDK.Lua.State;
using CESDK.SourceGenerators.LuaBindings;
using Microsoft.CodeAnalysis;
using Microsoft.CodeAnalysis.CSharp;
using Microsoft.CodeAnalysis.Diagnostics;

namespace CESDK.Analyzers.Tests.Generation;
...
///     <c>CESDK.SourceGenerators.LuaBindings</c>'s own shape-validation source instead of a hand-written copy. Test
///     compilations reference the REAL <c>CESDK.Annotations</c>, <c>CESDK.Lua.Interop</c> and <c>CESDK.Lua</c>
///     assemblies (not stubs: <c>CESDK.Lua.State.LuaState</c> is part of the shape the rules recognise), mirroring
///     <c>tests/CESDK.SourceGenerators.LuaBindings.Tests</c>' own approach.
/// </summary>
/// <remarks>
...
{
    private const string ShapeUsings = "using CESDK.Annotations.Lua;\nnamespace Demo;\n";
    ...
    // process (RoslynEnvironment of CESDK.SourceGenerators.LuaBindings.Tests does the same).
    ...
    // Same driver shape as CESDK.SourceGenerators.LuaBindings.Tests' GeneratorRun: "emits" means at least one
