...
/// </summary>
internal sealed class CesdkAnalyzerTest<TAnalyzer> : CSharpAnalyzerTest<TAnalyzer, DefaultVerifier>
    where TAnalyzer : DiagnosticAnalyzer, new()
{
    public CesdkAnalyzerTest(bool referenceCesdk = true)
    {
        ...
        if (referenceCesdk) ContractStubs.AddTo(TestState);
    }
}
