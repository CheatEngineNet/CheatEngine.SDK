...
public sealed class LocalFrameworkReferencesTests
{
    ...
    {
        CesdkAnalyzerTest<UnmanagedCallersOnlyGuardAnalyzer> test = new();
    ...
    {
        CesdkCodeFixTest<UnmanagedCallersOnlyGuardAnalyzer, UnmanagedCallersOnlyGuardCodeFixProvider> test = new();
