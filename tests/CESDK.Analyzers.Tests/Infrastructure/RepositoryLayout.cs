...
/// <summary>Locates files of the repository from the test output directory, for the documentation checks.</summary>
internal static class RepositoryLayout
{
    private const string SolutionFileName = "CESDK.slnx";

    /// <summary>The directory that contains <c>CESDK.slnx</c>, found by walking up from the test binaries.</summary>
