...
using CESDK.SourceGenerators.EntryPoint;
...
///     (<c>source-generators/CESDK.SourceGenerators.Shared/Shapes/PluginShape.cs</c>) is exercised here through its two
///     real call sites -
///     <c>CESDK.SourceGenerators.EntryPoint.EntryPointGenerator</c> and <c>CheatEnginePluginAnalyzer</c> - run over the
...
///     snippets of <c>tests/CESDK.SourceGenerators.EntryPoint.Tests/Generator/NoOutputTests.InvalidShapes</c> and
...
public sealed class PluginShapeParityTests
{
    ...
    // Same driver shape as CESDK.SourceGenerators.EntryPoint.Tests' GeneratorRun/RoslynFixture: "emits" means at
