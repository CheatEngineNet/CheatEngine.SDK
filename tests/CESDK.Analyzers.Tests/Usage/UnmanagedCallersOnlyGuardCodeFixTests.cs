...
using Verifier = CESDK.Analyzers.Tests.Infrastructure.CodeFixVerifier<
    CESDK.Analyzers.Usage.UnmanagedCallersOnlyGuardAnalyzer,
    CESDK.Analyzers.CodeFixes.Usage.UnmanagedCallersOnlyGuardCodeFixProvider>;

namespace CESDK.Analyzers.Tests.Usage;
