...
using Verifier =
    CESDK.Analyzers.Tests.Infrastructure.AnalyzerVerifier<CESDK.Analyzers.Usage.UnmanagedCallersOnlyGuardAnalyzer>;
...
public sealed class UnmanagedCallersOnlyGuardTests
{
    ...
    {
        await Verifier.VerifyWithoutCesdkAsync(Callbacks("""
                                                         [UnmanagedCallersOnly]
                                                         private static int OnCall(nint state)
                                                         {
                                                             return Work(state);
