...
namespace CESDK.Benchmarks.Support;

/// <summary>
///     A minimal ambient-runtime binding over one <see cref="NativeLuaState" />, for benchmarks that call generated
///     wrappers (<c>LuaRuntime.AcquireState()</c>) or a <c>CESDK.Engine.Objects.CEObject</c> property (which additionally
///     needs the host-object pusher). Deliberately smaller than
///     <c>tests/CESDK.Engine.Tests/Support/FakeHost.cs</c> (no per-object state, no xUnit, one fixed "Count" property
///     instead of a full object model): this is a benchmark fixture, not a correctness double, and this project does
///     not reference xUnit (<c>tests/CESDK.Tests.Shared/README.md</c>).
/// </summary>
/// <remarks>
...
internal static unsafe class FakeHostRuntime
{
    ...
    ///     by <c>CESDK.Engine.Objects.CEObject</c>'s property-get benchmark.
    /// </param>
    /// <returns>
