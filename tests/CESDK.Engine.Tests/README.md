...
Tests for `CESDK.Engine`: object handles, ownership, value conventions and enums, driven by a fake Cheat Engine object
model on a real Lua 5.3 library.
...
dotnet test --project tests/CESDK.Engine.Tests --filter-trait "Category=NativeLua"
```
