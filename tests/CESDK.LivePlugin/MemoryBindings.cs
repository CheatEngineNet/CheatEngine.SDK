...
///     <c>CESDK.Engine.Generated.MemoryScalars</c> already wraps this call. This declaration shows the
///     <c>[LuaGlobal]</c> pattern a plugin uses for any Cheat Engine Lua function that has no wrapper, and it
///     exercises the LuaBindings generator and the protected call machinery of <c>CESDK.Lua</c> inside a real plugin
///     assembly. <see cref="CesdkLivePlugin.OnEnable" /> calls it and logs the result.
/// </summary>
