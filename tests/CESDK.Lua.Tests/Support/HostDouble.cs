...
///     <c>void*</c>-typed <c>stdcall</c> pointers as <c>CESDK.Abi.ManagedExportedFunctions</c>): a state provider that
///     returns the state a test installed, and an object pusher that pushes the object pointer as a light userdata and
///     counts its calls.
/// </summary>
