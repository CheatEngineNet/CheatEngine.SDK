...
namespace CESDK.Lua.Tests.Text;
...
public sealed class Utf8ScratchTests
{
    ...
    public void Ascii_fits_the_stack_buffer_and_is_copied_byte_for_byte()
    {
        ...
        using var utf8 = Utf8Scratch.Encode("readInteger", scratch);
    ...
    public void Non_ascii_text_is_encoded_as_utf8()
    {
        ...
        Span<byte> scratch = stackalloc byte[Utf8Scratch.StackBufferSize];
        using var utf8 = Utf8Scratch.Encode("caf\u00E9 \u00FC \u20AC \uD83D\uDE00", scratch);
    ...
    {
        Span<byte> scratch = stackalloc byte[Utf8Scratch.StackBufferSize];
        using var high = Utf8Scratch.Encode("a\uD800b", scratch);
        ...
        using var low = Utf8Scratch.Encode("\uDC00", scratch2);
    ...
    {
        Span<byte> scratch = stackalloc byte[Utf8Scratch.StackBufferSize];
        using var utf8 = Utf8Scratch.Encode(ReadOnlySpan<char>.Empty, scratch);
    ...
    {
        var text = string.Concat(Enumerable.Repeat("\u00E9\u20AC\uD83D\uDE00x", 300));
        Span<byte> scratch = stackalloc byte[Utf8Scratch.StackBufferSize];
        using var utf8 = Utf8Scratch.Encode(text, scratch);
