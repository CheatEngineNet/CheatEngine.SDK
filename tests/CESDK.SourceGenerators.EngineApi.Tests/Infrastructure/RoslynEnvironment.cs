...
///     real <c>CESDK.Lua</c> (+ <c>CESDK.Lua.Interop</c>, <c>CESDK.Annotations</c>) assembly the generated wrappers are
...
internal sealed class RoslynEnvironment
{
    ...
    private RoslynEnvironment(ImmutableArray<MetadataReference> frameworkReferences)
    {
        ...
        [
            ...
            // Not a real CESDK.Engine reference (this project deliberately does not reference it): this test
            // assembly's own file, so a generated wrapper's 'global::CESDK.Engine.Values.Address'
            // resolves to Infrastructure/Address.cs (declared in namespace CESDK.Engine.Values), loaded a second
    ...
    /// <summary>
    ///     The real <c>CESDK.Annotations</c>, <c>CESDK.Lua.Interop</c> and <c>CESDK.Lua</c>, as loaded in this process,
