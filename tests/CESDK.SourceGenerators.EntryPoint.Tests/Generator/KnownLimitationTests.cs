...
///     <c>CESDK.Analyzers</c> to explain the silence. These tests pin that behaviour; the cases that have an analyzer
...
public sealed class KnownLimitationTests(RoslynFixture roslyn) : IClassFixture<RoslynFixture>
{
    ...
    [Fact]
    public void Generator_sdk_referenced_only_through_an_extern_alias_fails_in_generated_code_with_CS0234()
    {
        // The generated file names the contract as global::CESDK.Hosting.*, which an aliased reference does not feed.
        ...
        var compilation = CSharpCompilation.Create(
            ...
            [
                RoslynFixture.Parse(
                    $"extern alias sdk; namespace N {{ [sdk::CESDK.Annotations.Plugin.CheatEnginePlugin(\"x\")] public sealed class P : sdk::CESDK.Hosting.Plugin.CheatEnginePlugin {{ {Members} }} }}",
                    "Source0.cs")
            ],
            references,
        ...
        AssertOnlyErrorIsInGeneratedFile(run, "CS0234");
    }
