...
public sealed class PluginLocationTests(RoslynFixture roslyn) : IClassFixture<RoslynFixture>
{
    ...
    public void Generator_plugin_in_nested_namespace_uses_fully_qualified_name()
    {
        var run = roslyn.Run($$"""
                               ...
                               {
                                   [CESDK.Annotations.Plugin.CheatEnginePlugin("Trainer")]
    ...
    {
        var run = roslyn.Run($$"""
                               [CESDK.Annotations.Plugin.CheatEnginePlugin("Global")]
                               public sealed class GlobalPlugin : CESDK.Hosting.Plugin.CheatEnginePlugin
                               {
                                   {{PluginSources.LifecycleOverrides}}
                               }
                               """);
        ...
        var run = roslyn.Run($$"""
                               namespace Demo
                               {
                                   public static class Outer
                                   {
                                       ...
                                       {
                                           [CESDK.Annotations.Plugin.CheatEnginePlugin("Nested")]
                                           internal sealed class NestedPlugin : CESDK.Hosting.Plugin.CheatEnginePlugin
                                           {
                                               {{PluginSources.LifecycleOverrides}}
                                           }
                                       }
    ...
    public void Generator_partial_plugin_across_two_files_merges_the_declarations()
    {
        ...
        const string AttributedPart = """
                                      ...
                                      [CESDK.Annotations.Plugin.CheatEnginePlugin("Split")]
        ...
        const string OtherPart = $$"""
                                   ...
                                   public sealed partial class SplitPlugin : CESDK.Hosting.Plugin.CheatEnginePlugin
                                   {
                                       public SplitPlugin()
                                       {
                                       }
        ...
        var run = roslyn.Run(AttributedPart, OtherPart);
    ...
    public void Generator_plugin_named_like_a_keyword_escapes_the_identifier()
    {
        var run = roslyn.Run($$"""
                               namespace @namespace
                               {
                                   [CESDK.Annotations.Plugin.CheatEnginePlugin("Keyword")]
                                   public sealed class @class : CESDK.Hosting.Plugin.CheatEnginePlugin
                                   {
                                       {{PluginSources.LifecycleOverrides}}
                                   }
                               }
    ...
    public void Generator_plugin_with_non_ascii_identifiers_is_named_as_declared()
    {
        ...
        var run = roslyn.Run($$"""
                               ...
                               {
                                   [CESDK.Annotations.Plugin.CheatEnginePlugin("x")]
                                   public sealed class Plügin日 : CESDK.Hosting.Plugin.CheatEnginePlugin
                                   {
                                       {{PluginSources.LifecycleOverrides}}
                                   }
                               }
    ...
    public void Generator_plugin_named_like_the_file_local_factory_gets_another_factory_name()
    {
        ...
        var run = roslyn.Run($$"""
                               namespace CESDK
                               {
                                   [global::CESDK.Annotations.Plugin.CheatEnginePlugin("Factory")]
                                   public sealed class PluginFactory : global::CESDK.Hosting.Plugin.CheatEnginePlugin
                                   {
                                       {{PluginSources.LifecycleOverrides}}
                                   }
                               }
    ...
    public void Generator_plugin_nested_in_a_type_named_like_the_factory_gets_another_factory_name()
    {
        var run = roslyn.Run($$"""
                               namespace CESDK
                               {
                                   ...
                                   {
                                       [global::CESDK.Annotations.Plugin.CheatEnginePlugin("Nested")]
                                       public sealed class Inner : global::CESDK.Hosting.Plugin.CheatEnginePlugin
                                       {
                                           {{PluginSources.LifecycleOverrides}}
                                       }
                                   }
        ...
        string className)
    {
        ...
        var run = roslyn.Run($$"""
                               namespace {{@namespace}}
                               {
                                   [global::CESDK.Annotations.Plugin.CheatEnginePlugin("Look-alike")]
                                   public sealed class {{className}} : global::CESDK.Hosting.Plugin.CheatEnginePlugin
                                   {
                                       {{PluginSources.LifecycleOverrides}}
                                   }
                               }
    ...
    public void Generator_plugin_whose_name_only_starts_like_the_factory_keeps_the_default_factory_name()
    {
        var run = roslyn.Run($$"""
                               namespace CESDK
                               {
                                   [global::CESDK.Annotations.Plugin.CheatEnginePlugin("Prefix")]
                                   public sealed class PluginFactoryPlugin : global::CESDK.Hosting.Plugin.CheatEnginePlugin
                                   {
                                       {{PluginSources.LifecycleOverrides}}
                                   }
                               }
    ...
    public void Generator_plugin_inside_a_CESDK_namespace_still_compiles_thanks_to_global_names()
    {
        ...
        var run = roslyn.Run($$"""
                               ...
                               {
                                   [global::CESDK.Annotations.Plugin.CheatEnginePlugin("Inside")]
                                   public sealed class InsidePlugin : global::CESDK.Hosting.Plugin.CheatEnginePlugin
                                   {
                                       {{PluginSources.LifecycleOverrides}}
                                   }
                               }
