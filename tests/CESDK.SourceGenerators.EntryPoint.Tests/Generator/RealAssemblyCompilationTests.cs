...
///     <c>CESDK.Annotations</c> and <c>CESDK.Hosting</c> assemblies instead, so a real drift between the contract and
...
public sealed class RealAssemblyCompilationTests
{
    ...
    [Fact]
    public void Generated_bootstrap_compiles_clean_against_the_real_CESDK_Hosting_and_CESDK_Annotations()
    {
        ...
        Assert.True(
            problems.Length == 0,
            "Unexpected compiler diagnostics against the real CESDK.Hosting/CESDK.Annotations:\n" +
