...
///     <c>CESDK.Annotations.Plugin.CheatEnginePluginAttribute</c> and the <c>CESDK.Hosting</c> bootstrap types. They are
...
{
    public const string AssemblyName = "CESDK.ContractStubs";
    ...
    public const string Source = """
                                 ...
                                 namespace CESDK.Hosting.Bootstrap
                                 {
                                     public static class PluginHost
                                     {
                                         ...
                                         public static global::CESDK.Hosting.Plugin.CheatEnginePlugin? LastPlugin;

                                         public static int InitializeManaged<TFactory>(nint initRecord, int size)
                                             where TFactory : global::CESDK.Hosting.Plugin.IPluginFactory
                                         {
                                             CallCount++;
                                             if (size < 0)
                                             {
