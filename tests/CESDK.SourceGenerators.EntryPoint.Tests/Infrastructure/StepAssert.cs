...
internal static class StepAssert
{
    ...
    /// <summary>
    ///     Every CESDK-named step ran, produced something, and produced only <c>Cached</c>/<c>Unchanged</c> values; the
    ...
    public static void NothingWasRecomputed(GeneratorRunResult result)
    {
        ...
        Assert.Equal(EntryPointTrackingNames.All.Order(StringComparer.Ordinal), trackedCesdkSteps,
    ...
    /// <summary>Reasons of the source-output step; fails when there is none.</summary>
