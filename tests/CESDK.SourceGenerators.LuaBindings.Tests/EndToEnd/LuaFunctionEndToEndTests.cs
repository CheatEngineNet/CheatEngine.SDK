...
namespace CESDK.SourceGenerators.LuaBindings.Tests.EndToEnd;
...
public sealed class LuaFunctionEndToEndTests(RoslynFixture roslyn) : IClassFixture<RoslynFixture>
{
    ...
    {
        // Documented, deliberate behavior, not a gap: CESDK.Lua's string reads are strict (TryReadUtf8 checks
