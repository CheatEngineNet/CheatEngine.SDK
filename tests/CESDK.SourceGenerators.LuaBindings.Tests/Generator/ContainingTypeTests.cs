...
{
    private const string Usings = "using CESDK.Annotations.Lua;\n";
    ...
    public void Generator_nested_types_reopen_every_level()
    {
        ...
        var functions = run.GeneratedText("Demo.Inner.Outer.Bindings.LuaFunctions.g.cs");
        Assert.Contains(
    ...
    public void Generator_global_namespace_has_no_namespace_block()
    {
        ...
        run.AssertCompilesClean();
        var text = run.GeneratedText("Top.LuaFunctions.g.cs");
    ...
    {
        var run = roslyn.Run(Usings + "namespace Demo; " + declaration +
    ...
    public void Generator_keyword_identifiers_are_escaped()
    {
        ...
        run.AssertCompilesClean();
        var functions = run.GeneratedText("class.Demo.event.LuaFunctions.g.cs");
    ...
    public void Generator_non_ascii_type_name_gets_a_hashed_hint_name_and_an_unescaped_declaration()
    {
        ...
        run.AssertCompilesClean();
        var hintName = Assert.Single(run.HintNames);
    ...
    {
        var run = roslyn.Run(BindingSources.Mixed);
    ...
    {
        var run = roslyn.Run(Usings + "namespace Demo; public partial class Holder { [LuaGlobal(\"g\")] " + declared +
