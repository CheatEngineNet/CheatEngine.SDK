...
{
    private const string Usings = "using System; using CESDK.Annotations.Lua; using CESDK.Lua.State;\n";
    ...
    public void Generator_same_global_bound_twice_shares_one_cache_and_is_not_a_duplicate()
    {
        ...
        var text = run.SingleGeneratedText;
        Assert.Equal(1, Count(text, "private static readonly global::CESDK.Lua.References.LuaRef "));
