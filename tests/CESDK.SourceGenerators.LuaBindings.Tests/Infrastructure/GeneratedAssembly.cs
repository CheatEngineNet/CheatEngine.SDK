...
///     <see cref="AssemblyLoadContext" />, where <c>CESDK.Lua</c> and the other SDK assemblies resolve to the copies this
...
internal sealed class GeneratedAssembly
{
    ...
    public static GeneratedAssembly Load(GeneratorRun run)
    {
        ...
        AssemblyLoadContext context = new("CESDK.LuaBindings.Tests." + Interlocked.Increment(ref s_counter));
