...
/// <summary>
///     <c>build/CESDK.props</c> defaults <c>AllowUnsafeBlocks</c> and <c>EnableDynamicLoading</c> to <c>true</c> with a
...
public sealed class BuildPropertyDefaultsTests(PackagedUmbrellaFixture fixture)
{
    ...
    [Fact]
    public void CesdkGenerateEntryPoint_defaults_to_true_for_a_consumer_that_does_not_set_it()
    {
        Assert.Equal("true", fixture.DefaultProperties["CesdkGenerateEntryPoint"], true);
    }
