...
/// <summary>
///     A code-fix test with the same compilation setup as <see cref="CheatEngineSdkAnalyzerTest{TAnalyzer}" />. One run
///     checks
///     the diagnostics, the fix applied one diagnostic at a time, and Fix All in document, project and solution.
/// </summary>
internal sealed class
	CheatEngineSdkCodeFixTest<TAnalyzer, TCodeFix> : CSharpCodeFixTest<TAnalyzer, TCodeFix, DefaultVerifier>
