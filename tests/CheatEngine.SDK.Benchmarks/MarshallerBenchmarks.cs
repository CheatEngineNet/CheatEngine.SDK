...
public class MarshallerBenchmarks : IDisposable
{
	...
	public int PushReadInt32()
	{
		...
		_ = Int32Marshaller.TryRead(_l, -1, out int value);
		_l.SetTop(top);
		return value;
	}
	...
	public long PushReadInt64()
	{
		...
		_ = Int64Marshaller.TryRead(_l, -1, out long value);
		_l.SetTop(top);
		return value;
	}
	...
	public float PushReadSingle()
	{
		...
		_ = SingleMarshaller.TryRead(_l, -1, out float value);
		_l.SetTop(top);
		return value;
	}
	...
	public double PushReadDouble()
	{
		...
		_ = DoubleMarshaller.TryRead(_l, -1, out double value);
		_l.SetTop(top);
		return value;
	}
	...
	public bool PushReadBoolean()
	{
		...
		_ = BooleanMarshaller.TryRead(_l, -1, out bool value);
		_l.SetTop(top);
		return value;
	}
	...
	public nuint PushReadAddress()
	{
		...
		_ = AddressMarshaller.TryRead(_l, -1, out UIntPtr value);
		_l.SetTop(top);
		return value;
	}
	...
	{
		int top = _l.Top;
		Utf8Marshaller.Push(_l, "cheatengine.sdk"u8);
		_ = Utf8Marshaller.TryRead(_l, -1, out ReadOnlySpan<byte> value);
	...
	{
		int top = _l.Top;
		StringMarshaller.Push(_l, "cheatengine.sdk");
		_ = StringMarshaller.TryRead(_l, -1, out string? value);
		_l.SetTop(top);
