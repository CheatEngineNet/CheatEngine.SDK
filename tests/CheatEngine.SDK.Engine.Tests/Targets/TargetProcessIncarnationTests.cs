...
public sealed class TargetProcessIncarnationTests
{
    ...
    public void Constructor_with_an_invalid_identity_component_rejects_the_component(int processId, long startedAtUtcTicks,
    ...
    public void Value_identity_uses_both_the_PID_and_observed_creation_time()
    {
        ...
        Assert.False(original.Equals((object?)null));
