...
public sealed class NativeLuaProbeTests
{
    ...
    {
        var relative = Path.Combine("cheatengine-sdk-no-such-directory", "lua53.dll");
    ...
    {
        var missing = Path.Combine(Path.GetTempPath(), "cheatengine-sdk-no-such-directory", "lua53.dll");
