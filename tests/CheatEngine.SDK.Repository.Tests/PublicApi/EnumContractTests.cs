...
public sealed class EnumContractTests
{
	...
	private static readonly Dictionary<string, EnumCategory> s_addedEnums = new(StringComparer.Ordinal)
	{
		...
		["CheatEngine.SDK.Engine.AddressList.MemoryRecordActivationOutcomeKind"] = EnumCategory.StatusOrOutcome,
		...
		["CheatEngine.SDK.Engine.Assembly.AutoAssemblerApplyOutcomeKind"] = EnumCategory.StatusOrOutcome,
		["CheatEngine.SDK.Engine.Assembly.AutoAssemblerCheckOutcomeKind"] = EnumCategory.StatusOrOutcome,
		["CheatEngine.SDK.Engine.Assembly.AutoAssemblerDisableInfoSnapshotStatus"] = EnumCategory.StatusOrOutcome,
		...
		["CheatEngine.SDK.Engine.Objects.EngineEffectState"] = EnumCategory.StatusOrOutcome,
		...
		["CheatEngine.SDK.Engine.Scanning.Aob.AobFirstFoundOutcomeKind"] = EnumCategory.StatusOrOutcome,
