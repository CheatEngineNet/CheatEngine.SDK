...
///     runs: symbols, syntax, locations, semantic models, compilations, and the <c>AdditionalText</c> the raw filter
///     step still holds (its own step is exempt below since it is expected to hold one).
/// </summary>
