...
internal static class StepAssert
{
    ...
    /// <summary>
    ///     Every CheatEngine.SDK-named step ran, produced something, and produced only <c>Cached</c>/<c>Unchanged</c> values; no
    ...
    public static void NothingWasRecomputed(GeneratorRunResult result)
    {
        ...
        Assert.Equal(EngineApiTrackingNames.All.Order(StringComparer.Ordinal), trackedCheatEngineSdkSteps,
