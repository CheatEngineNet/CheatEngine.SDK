...
public sealed class SpecFileParserTests
{
    ...
    {
        var spec = SpecFileParser.Parse("memory-scalars.cheatengine-sdk-api.txt", SpecSources.Memory);
    ...
    {
        var spec = SpecFileParser.Parse("shared.cheatengine-sdk-api.txt", SpecSources.SharedGlobal);
    ...
    {
        var spec = SpecFileParser.Parse("empty.cheatengine-sdk-api.txt", string.Empty);
    ...
    {
        var spec = SpecFileParser.Parse("x.cheatengine-sdk-api.txt", "# nothing here\n# still nothing\n");
    ...
    {
        var spec = SpecFileParser.Parse("x.cheatengine-sdk-api.txt", "namespace: Demo\n");
    ...
    {
        var spec = SpecFileParser.Parse("x.cheatengine-sdk-api.txt", "namespace: 1Bad.Name\ntype: T\n");
