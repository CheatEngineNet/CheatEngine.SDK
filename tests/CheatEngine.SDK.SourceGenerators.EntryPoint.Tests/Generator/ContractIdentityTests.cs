...
public sealed class ContractIdentityTests(RoslynFixture roslyn) : IClassFixture<RoslynFixture>
{
	...
	{
		PortableExecutableReference foreignEntryPoint = CreateReference(
			roslyn.Environment,
			"Foreign.EntryPoint",
			"""
			namespace CESDK
	...
	{
		PortableExecutableReference foreignAttribute = CreateReference(
			roslyn.Environment,
	...
	{
		PortableExecutableReference foreignBase = CreateReference(
			roslyn.Environment,
