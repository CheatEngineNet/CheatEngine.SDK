...
public sealed class DefaultVerifierTests
{
	...
	{
		CSharpSourceGeneratorTest<EntryPointGenerator, DefaultVerifier> test = CreateTest();
	...
	{
		CSharpSourceGeneratorTest<EntryPointGenerator, DefaultVerifier> test = CreateTest(false);
