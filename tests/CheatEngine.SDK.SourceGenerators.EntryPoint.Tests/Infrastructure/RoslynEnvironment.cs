...
internal sealed class RoslynEnvironment
{
	...
	{
		CSharpCompilation annotations = CSharpCompilation.Create(
			...
			frameworkReferences,
			CompilationOptions);
		CSharpCompilation hosting = CSharpCompilation.Create(
