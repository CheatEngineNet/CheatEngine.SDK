...
public sealed class LuaFunctionTablesTests
{
	...
	{
		EquatableArray<LuaFunctionTableModel> tables = LuaFunctionTables.Group(
		[
			Function(Zeta, "z"),
			Function(Alpha, "b"),
			Function(Alpha, "a")
	...
	public void Group_skips_invalid_members_and_types_left_without_a_valid_one()
	{
		...
		LuaFunctionTableModel table = Assert.Single(tables);
	...
	public void Group_assigns_case_insensitive_collision_names_independent_of_input_order()
	{
		...
		EquatableArray<LuaFunctionTableModel> forward =
			LuaFunctionTables.Group([Function(lower, "lower"), Function(upper, "upper")]);
		EquatableArray<LuaFunctionTableModel> reverse =
			LuaFunctionTables.Group([Function(upper, "upper"), Function(lower, "lower")]);
