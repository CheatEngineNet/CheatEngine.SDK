...
`CheatEngine.SDK.Lua` to the copy the test process runs. So the `LuaRuntime` a test attaches is the one the generated code
...
lookup and the skip reason are described in [`tests/CheatEngine.SDK.Tests.Shared/README.md`](../CheatEngine.SDK.Tests.Shared/README.md).
