...
internal sealed class GeneratorRun
{
	...
	public static GeneratorRun Execute(GeneratorDriver driver, Compilation compilation)
	{
		...
		GeneratorDriverRunResult driverResult = updated.GetRunResult();
		GeneratorRunResult generatorResult = Assert.Single(driverResult.Results);
	...
	public void AssertCompilesClean()
	{
		...
		ImmutableArray<Diagnostic>
			diagnostics = OutputCompilation.GetDiagnostics(TestContext.Current.CancellationToken);
