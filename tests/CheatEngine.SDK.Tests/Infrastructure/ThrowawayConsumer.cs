...
internal sealed class ThrowawayConsumer
{
    ...
    ///     x64/net10.0 class library with one <c>PackageReference</c> to <c>CheatEngine.SDK</c> restored only from
        ...
        File.WriteAllText(projectPath, $"""
                                        <Project Sdk="Microsoft.NET.Sdk">
                                          <PropertyGroup>
                                            ...
                                            <!-- CheatEngineSdkRequireX64Platform (build/CheatEngine.SDK.props) refuses PlatformTarget=x86; this is the ordinary, supported choice. -->
